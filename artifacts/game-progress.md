...
- Q1 Archive now writes the three Dreamweaver answers in order after Omega finishes. The answer words appear first; the floor and paths reveal after Ambition. TypeScript typecheck passed, and the live browser showed the first Light word and the completed three-path state.
