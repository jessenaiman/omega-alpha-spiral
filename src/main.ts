...
try {
  ...
  const host: SceneHost = createSceneHost({
    ...
    closingQuestion: CHRONICLE_QUESTIONS[CHRONICLE_QUESTIONS.length - 1]!.question,
    dreamweaverQuestions: CHRONICLE_QUESTIONS[0]!.choices.map(getDreamweaverQuestion),
